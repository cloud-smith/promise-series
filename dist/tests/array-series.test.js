...
it('should test array series error handling', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        expect(JSON.stringify(error)).toStrictEqual("{\"isTasksSuccessful\":false,\"isRollbacksSuccessful\":false,\"errors\":{\"tasks\":[{\"number\":2,\"name\":\"task-2\",\"error\":\"Task simulated failure\"}],\"rollbacks\":[]},\"tasks\":[{\"number\":1,\"name\":\"task-1\",\"results\":\"Task Success\"},{\"number\":2,\"name\":\"task-2\",\"error\":\"Task simulated failure\"},{\"number\":3,\"name\":\"task-3\"}],\"rollbacks\":[]}");
    }
}));
